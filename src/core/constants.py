...
STORY_PAGES: Final[list[list[str]]] = [
    ["You were making record time at the Miller Farm's annual",
    "corn maze contest, when all of a sudden you tripped over",
    "a rogue pumpkin, and the world went to black."],

    ["When you awaken, you are greeted by nightfall. Not only",
    "is it pitch black, you soon realize the map you made is",
    "useless as you keep stumbling into corn stalks."],
    
    ["The wind suddenly stops, and an eerie sound whistles",
    "through the dry husks. A pit develops in your stomach,",
    "and you understand now that the legend is true."],
    
    ["The Miller Farm is home to a supernatural guardian",
    "scarecrow that patrols its fields. If it finds you,",
    "you'll never see another sunrise."],
    
    ["Your only hope of survival is to take refuge in the",
    "lookout tower, if only you can navigate through the",
    "dark labyrinth of green and yellow."],
    
    ["It dawns on you, your backpack is full of industrial-grade,",
    "white, neon glow sticks. They are very bright, but they",
    "also attract unwanted attention."],
    
    ["Cautiously using your glow sticks to help guide you,",
    "avoid the paranormal sentinel, and find your way to",
    "the lookout tower in the Midnight Maize."]
    ]
